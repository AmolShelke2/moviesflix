...
const heroBanner = function ({ results: movieList }) {
  ...
  /**
   * fetch data for home page sections (top rated, upcoming movies, top rated )
   */
...
const createMovieList = function ({ results: movieList }, title) {
  ...
  for (const movies of movieList) {
    const movieCard = createMovieCard(movies); // called from movie_card.js
